...
public class HttpRenderUtil {
    ...
    public static FullHttpResponse render(Object content, RenderType renderType) {
        ...
        response.headers().add(HttpHeaders.Names.CONTENT_TYPE, type.getContentType());
        response.headers().add(HttpHeaders.Names.CONTENT_LENGTH, String.valueOf(byteBuf.readableBytes()));
        return response;
    }
